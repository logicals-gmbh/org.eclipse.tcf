 ...
 *
 * These methods are used by Protocol, TransientPeer, AbstractChannel, and
 * others.
 */
public class TransportManager {
     ...
     */
    private static final HashMap<String, ITransportProvider> transports = new HashMap<String, ITransportProvider>();
     ...
     * is thrown
     *
     * This is internal API, TCF clients should use
     * {@code org.eclipse.tcf.protocol.Protocol}
     *
     * @param transport
    ...
    /**
     * Removes the channel from the collection of channels. This method is
     * called by the Channel whenever it closes.
     *
     * @param channel
     *            channel to close
     * @param x
    ...
    /**
     * Add a Channel Open Listener, i.e: a listener that will be notified when a
     * channel is opened
     *
     * This is internal API, TCF clients should use
     * {@code org.eclipse.tcf.protocol.Protocol}
    ...
    /**
     * Remove a Channel Open Listener, i.e: a listener that will be notified
    ...
    /**
     * Transmit TCF event message. The message is sent to all open communication
    ...
    public static void sendEvent(String service_name, String event_name, byte[] data) {
        for (AbstractChannel c : channels) {
            // Skip channels that are executing "redirect" command -
            // STATE_OPENING
     ...
     * throughput. Most clients don't need cross channel synchronization and
     * should not call this method.
     *
     * @param done
     *            will be executed by dispatch thread after communication
